...
<main id="layout-wrapper">
    ...
    <div class="form-wrapper">
        ...
        <form style="width: 60%; margin: 0 auto">
            <div class="fieldRow">
                <label for="firstname">Enquiry Type </label> <br/>
                <select >
            ...
            <div class="fieldRow">
                <label style="    margin-left: -285px !important;" for="lastname">Email: </label><br/>
                <input type="text" id="lastname" name="lastname"/>
            </div>
            <div class="fieldRow" style="float: left;">
                <label style="margin-left: -275px !important;" for="lastname">Mobile: </label><br/>
                <input type="text" id="lastname" name="lastname"/>
            </div>
            <div class="clear"></div>
            <div class="fieldRow">
            ...
            <div class="fieldRow">
                <span class="mktoButtonWrap mktoGlow"><button type="submit" class="mktoButton">Submit</button></span>
            </div>
        </form>
    </div>
    </section>
