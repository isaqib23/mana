...
<section class="tac" style="width: 80%; margin: 0 auto;">
    <video
            ...
            preload="auto"
            width="100%"
            poster="<?=baseUrl()?>/assets/Uploads/<?=$_GET["video"]?>.png"
            data-setup="{}"
    >
        <source src="<?=baseUrl()?>/assets/Uploads/<?=$_GET["video"]?>.mp4" type="video/mp4" />
        <source src="<?=baseUrl()?>/assets/Uploads/<?=$_GET["video"]?>.mp4" type="video/webm" />
    </video>
</section>
